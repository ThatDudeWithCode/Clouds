...
if(isset($_POST['register_button'])){
    ...
    if(empty($error_array)){
        ...
        if($rand == 1)
            ...
            $profile_pic = "assets/images/avatar2.png";

        $query = mysqli_query($con, "INSERT INTO users VALUES ('', '$fname', '$lname', '$username', '$em', '$password', '$date', '$profile_pic', '0', '0', 'no', ',')");
        array_push($error_array, "You are registered and can now <a href='login.php'></a>!");

        // Clear the form once signup js complete.
        $_SESSION['reg_fname'] = "";
        $_SESSION['reg_lname'] = "";
        $_SESSION['reg_email'] = "";
        $_SESSION['reg_email2'] = "";
